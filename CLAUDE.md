...
- **No Git**: Falls back to `SHUTTERSENSE_VERSION` environment variable or `v0.0.0-dev+unknown`
...
- Set `SHUTTERSENSE_VERSION` environment variable
- Example: `export SHUTTERSENSE_VERSION=v1.5.0-build.42`
